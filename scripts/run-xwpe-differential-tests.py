...
# Wrap gcc with ccache so the system-side and compat-side objects hit the
# ccache the CI cache action primed. Bare CC=gcc would recompile cold.
...
def main():
    ...
    parser.add_argument(
        "--display",
        default=parse_env_default("XWPE_DIFF_DISPLAY", "127"),
    )
    parser.add_argument(
        "--geometry",
