...
static const struct {
    ...
    /* Missing in X11: SDLK_POWER, SDLK_CUT, SDLK_COPY, SDLK_PASTE, SDLK_MUTE,
     * SDLK_VOLUMEUP, SDLK_VOLUMEDOWN, SDLK_OUT, SDLK_OPER, SDLK_CLEARAGAIN,
     * SDLK_CRSEL, SDLK_EXSEL, SDLK_KP_00, SDLK_KP_000, SDLK_KP_XOR,
     * SDLK_KP_POWER, SDLK_KP_DBLAMPERSAND, SDLK_KP_DBLVERTICALBAR,
     * SDLK_KP_MEMSTORE, SDLK_KP_MEMRECALL, SDLK_KP_MEMCLEAR, SDLK_KP_MEMADD,
