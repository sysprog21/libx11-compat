...
#define GL_TYPE_SWITCH_ALT(name, var, name2, var2, type, code, extra)         \
    switch (type) {                                                           \
        ...
        GL_TYPE_CASE_ALT(name, var, name2, var2, GL_UNSIGNED_BYTE, GLubyte,   \
                         code)                                                \
        GL_TYPE_CASE_ALT(name, var, name2, var2, GL_UNSIGNED_INT, GLuint,     \
                         code)                                                \
...
#define GL_TYPE_SWITCH_MAX(name, var, type, code, extra)                      \
    switch (type) {                                                           \
        ...
        GL_TYPE_CASE_MAX(name, var, GL_UNSIGNED_INT, GLuint, code,            \
                         4294967295l)                                         \
