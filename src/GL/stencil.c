...
void APIENTRY_GL4ES gl4es_glStencilMaskSeparate(GLenum face, GLuint mask)
{
    ...
    if (gles_glStencilMaskSeparate) {
        ...
        // fake function..., call it only for front or front_and_back, just
        // ignore back (crappy, I know)
        if (face == GL_FRONT)
            gl4es_glStencilMask(mask);
        else
            noerrorShim();
...
void APIENTRY_GL4ES gl4es_glStencilFuncSeparate(GLenum face,
                                                GLenum func,
                                                GLint ref,
                                                GLuint mask)
{
...
void APIENTRY_GL4ES gl4es_glStencilOpSeparate(GLenum face,
                                              GLenum sfail,
                                              GLenum zfail,
                                              GLenum zpass)
{
