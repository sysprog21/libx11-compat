...
typedef struct {
    GLboolean line_stipple, auto_normal, normalize, normal_rescale, lighting,
        alpha_test, fog, color_material, blend, cull_face, color_sum,
        depth_test, stencil_test, pointsprite, point_size, texgen_s[MAX_TEX],
        ...
        map2_texture1, map2_texture2, map2_texture3, map2_texture4,
        map2_vertex3, map2_vertex4, color_logic_op, line_smooth, point_smooth,
        polyfill_offset, vertex_arb, vertex_two_side_arb, fragment_arb,
...
typedef struct {
    ...
    int map_i2b_size;
    int map_i2a_size;
    /* int map_s2s_size; int map_r2r_size; int map_g2g_size; int map_b2b_size;
     * int map_a2a_size;
     */
    ...
    /* GLuint map_s2s[MAX_MAP_SIZE]; GLubyte map_r2r[MAX_MAP_SIZE]; GLubyte
     * map_g2g[MAX_MAP_SIZE]; GLubyte map_b2b[MAX_MAP_SIZE]; GLubyte
     * map_a2a[MAX_MAP_SIZE];
     */
    GLubyte *data;
