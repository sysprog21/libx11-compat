// TODO: glIsEnabled(), glGetMap() TODO: GL_AUTO_NORMAL
...
void APIENTRY_GL4ES gl4es_glMap1d(GLenum target,
                                  GLdouble u1,
                                  GLdouble u2,
                                  GLint ustride,
                                  GLint uorder,
...
void APIENTRY_GL4ES gl4es_glMap1f(GLenum target,
                                  GLfloat u1,
                                  GLfloat u2,
                                  GLint ustride,
                                  GLint uorder,
...
void APIENTRY_GL4ES gl4es_glMap2d(GLenum target,
                                  GLdouble u1,
                                  GLdouble u2,
                                  GLint ustride,
                                  GLint uorder,
...
void APIENTRY_GL4ES gl4es_glMap2f(GLenum target,
                                  GLfloat u1,
                                  GLfloat u2,
                                  GLint ustride,
                                  GLint uorder,
...
#define iter_maps(d, code)                                                  \
    ...
    p_map(d, vertex4, glVertex4f, code) else p_map(d, vertex3, glVertex3f,  \
                                                   code);
...
void APIENTRY_GL4ES gl4es_glEvalCoord2f(GLfloat u, GLfloat v)
{
    ...
    iter_maps(
        ...
        if (glstate->enable.auto_normal &&
            ...
            out[3] = 1.0f;
            _math_de_casteljau_surf((GLfloat *) map->points, out, du, dv, uu,
                                    vv, map->width, map->u.order, map->v.order);
            if (map->width == 4) {
...
void APIENTRY_GL4ES gl4es_glMapGrid2f(GLint un,
                                      GLfloat u1,
                                      GLfloat u2,
                                      GLint vn,
                                      GLfloat v1,
...
void APIENTRY_GL4ES
gl4es_glEvalMesh2(GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2)
{
    GLenum renderMode = eval_mesh_prep(mode);
    if (!renderMode) {
        errorShim(GL_INVALID_ENUM);
...
#define GL_GET_MAP(t, type)                                               \
    ...
    {                                                                     \
        noerrorShim();                                                    \
        map_statef_t **slot = (map_statef_t **) get_map_pointer(target);  \
        if (!slot) {                                                      \
            errorShim(GL_INVALID_ENUM);                                   \
            return;                                                       \
        }                                                                 \
        map_statef_t *map = *slot;                                        \
        if (map) {                                                        \
            switch (query) {                                              \
            case GL_COEFF: {                                              \
