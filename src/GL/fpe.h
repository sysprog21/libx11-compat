...
typedef struct fpe_texture_s {
    ...
    unsigned int
        texformat : 3;  // textures (simplified) internal format on 3 bits
} fpe_texture_t;
...
typedef struct fpe_texenv_s {
    ...
    unsigned int
        texopalpha0 : 1;  // texenv src op (OPERATION_n_ALPHA is 1 bits)
    unsigned int
        texopalpha1 : 1;  // texenv src op (OPERATION_n_ALPHA is 1 bits)
    unsigned int
        texopalpha2 : 1;  // texenv src op (OPERATION_n_ALPHA is 1 bits)
    unsigned int
        texopalpha3 : 1;          // texenv src op (OPERATION_n_ALPHA is 1 bits)
    ...
    unsigned int
        texalphascale : 1;   // flag if ALPHA_SCALE for texture is != 1.0
...
typedef struct fpe_state_s {
    ...
    uint8_t texcombine[MAX_TEX];  // 16 texture combined (RGB as lower 4 bits, A
                                  // as higher 4 bits)
    ...
    uint16_t fragment_prg_id;  // Id of fragment program currently binded (0
                               // most of the time)
} fpe_state_t;
#pragma pack()
...
void APIENTRY_GLES fpe_glMultiTexCoord4f(GLenum target,
                                         GLfloat s,
                                         GLfloat t,
                                         GLfloat r,
                                         GLfloat q);
void APIENTRY_GLES fpe_glSecondaryColorPointer(GLint size,
                                               GLenum type,
                                               GLsizei stride,
                                               const GLvoid *pointer);
void APIENTRY_GLES fpe_glVertexPointer(GLint size,
                                       GLenum type,
                                       GLsizei stride,
                                       const GLvoid *pointer);
void APIENTRY_GLES fpe_glColorPointer(GLint size,
                                      GLenum type,
                                      GLsizei stride,
                                      const GLvoid *pointer);
void APIENTRY_GLES fpe_glNormalPointer(GLenum type,
                                       GLsizei stride,
                                       const GLvoid *pointer);
void APIENTRY_GLES fpe_glTexCoordPointer(GLint size,
                                         GLenum type,
                                         GLsizei stride,
                                         const GLvoid *pointer);
void APIENTRY_GLES fpe_glTexCoordPointerTMU(GLint size,
                                            GLenum type,
                                            GLsizei stride,
                                            const GLvoid *pointer,
                                            int TMU);
void APIENTRY_GLES fpe_glFogCoordPointer(GLenum type,
                                         GLsizei stride,
                                         const GLvoid *pointer);
...
void APIENTRY_GLES fpe_glDrawElements(GLenum mode,
                                      GLsizei count,
                                      GLenum type,
...
void APIENTRY_GLES fpe_glDrawElements(GLenum mode,
                                      ...
                                      GLenum type,
                                      const GLvoid *indices);
void APIENTRY_GLES fpe_glDrawArraysInstanced(GLenum mode,
                                             GLint first,
                                             GLsizei count,
                                             GLsizei primcount);
void APIENTRY_GLES fpe_glDrawElementsInstanced(GLenum mode,
                                               GLsizei count,
                                               GLenum type,
                                               const GLvoid *indices,
                                               GLsizei primcount);
void APIENTRY_GLES fpe_glColor4f(GLfloat red,
                                 GLfloat green,
                                 GLfloat blue,
                                 GLfloat alpha);
...
void APIENTRY_GLES fpe_glLightfv(GLenum light,
                                 GLenum pname,
                                 const GLfloat *params);
void APIENTRY_GLES fpe_glMaterialfv(GLenum face,
                                    GLenum pname,
                                    const GLfloat *params);
void APIENTRY_GLES fpe_glMaterialf(GLenum face,
                                   GLenum pname,
                                   const GLfloat param);
