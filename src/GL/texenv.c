...
void APIENTRY_GL4ES gl4es_glTexEnvf(GLenum target, GLenum pname, GLfloat param)
{
    ...
    case GL_TEXTURE_ENV: {
        ...
        case GL_TEXTURE_ENV_MODE:
            ...
            } else if (param != GL_ADD && param != GL_MODULATE &&
                       param != GL_DECAL && param != GL_BLEND &&
        ...
        case GL_SRC0_RGB:
            ...
            if (glstate->fpe_state) {
                ...
                if (t->src0_rgb >= GL_TEXTURE0 &&
                    t->src0_rgb < GL_TEXTURE0 + MAX_TEX) {
        ...
        case GL_SRC1_RGB:
            ...
            if (glstate->fpe_state) {
                int state = FPE_SRC_TEXTURE;
                if (t->src1_rgb >= GL_TEXTURE0 &&
                    t->src1_rgb < GL_TEXTURE0 + MAX_TEX) {
        ...
        case GL_SRC2_RGB:
            ...
            if (glstate->fpe_state) {
                int state = FPE_SRC_TEXTURE;
                if (t->src2_rgb >= GL_TEXTURE0 &&
                    t->src2_rgb < GL_TEXTURE0 + MAX_TEX) {
                    ...
                    case GL_SECONDARY_COLOR_ATIX:
                        ...
                        break;
                        // case GL_TEXTUTRE_OUTPUT: unknown, so fall back to
                        // texture...
                    }
...
void APIENTRY_GL4ES gl4es_glTexEnvfv(GLenum target,
                                     GLenum pname,
                                     const GLfloat *param)
{
...
void APIENTRY_GL4ES gl4es_glTexEnviv(GLenum target,
                                     GLenum pname,
                                     const GLint *param)
{
...
void APIENTRY_GL4ES gl4es_glGetTexEnvfv(GLenum target,
                                        GLenum pname,
                                        GLfloat *params)
{
...
void APIENTRY_GL4ES gl4es_glGetTexEnviv(GLenum target,
                                        GLenum pname,
                                        GLint *params)
{
    noerrorShim();
