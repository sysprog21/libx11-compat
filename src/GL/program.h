...
typedef struct {
    ...
    shaderconv_need_t *default_need;  // filled only if default_vertex or
                                      // default_fragment is used
...
GLvoid APIENTRY_GL4ES glGetActiveAttribARB(GLhandleARB programObj,
                                           GLuint index,
                                           GLsizei maxLength,
                                           GLsizei *length,
                                           GLint *size,
...
GLvoid APIENTRY_GL4ES glShaderSourceARB(GLhandleARB shaderObj,
                                        GLsizei count,
...
GLvoid APIENTRY_GL4ES glGetObjectParameterfvARB(GLhandleARB obj,
                                                GLenum pname,
                                                GLfloat *params);
GLvoid APIENTRY_GL4ES glGetObjectParameterivARB(GLhandleARB obj,
                                                GLenum pname,
                                                GLint *params);
GLvoid APIENTRY_GL4ES glGetInfoLogARB(GLhandleARB obj,
                                      GLsizei maxLength,
                                      GLsizei *length,
                                      GLcharARB *infoLog);
...
GLvoid APIENTRY_GL4ES glGetActiveUniformARB(GLhandleARB programObj,
                                            ...
                                            GLenum *type,
                                            GLcharARB *name);
GLvoid APIENTRY_GL4ES glGetUniformfvARB(GLhandleARB programObj,
                                        GLint location,
                                        GLfloat *params);
GLvoid APIENTRY_GL4ES glGetUniformivARB(GLhandleARB programObj,
                                        GLint location,
                                        GLint *params);
GLvoid APIENTRY_GL4ES glGetShaderSourceARB(GLhandleARB obj,
                                           GLsizei maxLength,
                                           GLsizei *length,
                                           GLcharARB *source);
