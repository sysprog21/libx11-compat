...
void APIENTRY_GL4ES gl4es_glVertex4f(GLfloat x,
                                     GLfloat y,
                                     GLfloat z,
                                     GLfloat w);
...
void APIENTRY_GL4ES gl4es_glMaterialfv(GLenum face,
                                       GLenum pname,
                                       const GLfloat *params);
void APIENTRY_GL4ES gl4es_glMaterialf(GLenum face,
                                      GLenum pname,
                                      const GLfloat param);
...
// glGetError() return last error, but that error is not reset until read So if
// 2 operations generate an error, the 2nd error is lost if glGetError has not
// been called after 1st op
static inline void errorGL()
{  // next glGetError will be from GL
...
static inline void errorShim(GLenum error)
{  // next glGetError will be "error" from gl4es
    if (glstate->type_error && glstate->shim_error == GL_NO_ERROR)
...
void APIENTRY_GL4ES glFrustum(GLdouble left,
                              GLdouble right,
                              GLdouble bottom,
                              GLdouble top,
                              GLdouble Near,
...
void APIENTRY_GL4ES glInterleavedArrays(GLenum format,
                                        GLsizei stride,
                                        const GLvoid *pointer);
...
void APIENTRY_GL4ES glOrtho(GLdouble left,
                            GLdouble right,
                            GLdouble bottom,
                            GLdouble top,
                            GLdouble Near,
