...
void init_sampler(glsampler_t *sampler)
{
    ...
    sampler->wrap_s = sampler->wrap_t =
        (globals4es.defaultwrap ? 0 : GL_REPEAT);
...
void gl4es_glGetSamplerParameterfv(GLuint sampler,
                                   GLenum pname,
                                   GLfloat *params)
{
    glsampler_t *s = find_sampler(sampler);
...
void gl4es_glGetSamplerParameteriv(GLuint sampler,
                                   GLenum pname,
                                   GLfloat *params)
{
    glsampler_t *s = find_sampler(sampler);
...
void gl4es_glGetSamplerParameterIuiv(GLuint sampler,
                                     GLenum pname,
                                     GLuint *params)
{
    glsampler_t *s = find_sampler(sampler);
