...
void rlColor4f(renderlist_t *list,
               GLfloat r,
               GLfloat g,
               GLfloat b,
               GLfloat a) FASTMATH;
...
void rlMultiTexCoord4f(renderlist_t *list,
                       GLenum texture,
                       GLfloat s,
                       GLfloat t,
                       GLfloat r,
                       GLfloat q) FASTMATH;
void rlMultiTexCoord2fv(renderlist_t *list,
                        GLenum texture,
                        GLfloat *v) FASTMATH;
void rlMultiTexCoord4fv(renderlist_t *list,
                        GLenum texture,
                        GLfloat *v) FASTMATH;
void rlVertex4f(renderlist_t *list,
                GLfloat x,
                GLfloat y,
                GLfloat z,
                GLfloat w) FASTMATH;
...
void rlSecondary3f(renderlist_t *list,
                   GLfloat r,
                   GLfloat g,
                   GLfloat b) FASTMATH;
void rlRasterOp(renderlist_t *list,
                int op,
                GLfloat x,
                GLfloat y,
                GLfloat z) FASTMATH;
