...
void APIENTRY_GL4ES gl4es_glBlendEquationSeparatei(GLuint buf,
                                                   GLenum modeRGB,
                                                   GLenum modeAlpha);
void APIENTRY_GL4ES gl4es_glBlendFuncSeparatei(GLuint buf,
                                               GLenum srcRGB,
                                               GLenum dstRGB,
                                               GLenum srcAlpha,
                                               GLenum dstAlpha);
void APIENTRY_GL4ES gl4es_glCopyPixels(GLint x,
                                       GLint y,
                                       GLsizei width,
                                       GLsizei height,
                                       GLenum type);
...
void APIENTRY_GL4ES gl4es_glColorTable(GLenum target,
...
void APIENTRY_GL4ES gl4es_glFeedbackBuffer(GLsizei size,
                                           GLenum type,
                                           GLfloat *buffer);
